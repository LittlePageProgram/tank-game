...
public class AudioUtils {
	...
	public AudioUtils(String fileName) {
		try {
			audioInputStream = AudioSystem.getAudioInputStream(AudioUtils.class.getClassLoader().getResource(fileName));
	...
	public static void main(String[] args) {
		...
		AudioUtils a = new AudioUtils("audio/war1.wav");
		a.loop();
